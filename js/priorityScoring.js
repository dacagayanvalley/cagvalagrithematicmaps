...
const PriorityScoring = (() => {
  ...
  function formatBreakdown(row, modelKey) {
    ...
    const labelMap = {
      ...
      asf_positive_rate_pct: "ASF Positivity Rate",
      asf_affected_barangays: "ASF Affected Barangays",
      ...
      bswm_fertilizer_constraint_score: "BSWM FertMap Constraint",
      bswm_coverage_confidence_score: "BSWM FertMap Coverage Confidence",
      bswm_acidic_sample_pct: "BSWM Acidic Sample Share",
      bswm_multiple_low_npk_pct: "BSWM Multiple Low Nutrient Share",
      bswm_low_p_pct: "BSWM Low Phosphorus Share",
      bswm_low_k_pct: "BSWM Low Potassium Share",
      ...
      pagasa_powerbi_agri_risk_score: "PAGASA Power BI Agri Risk",
      pagasa_powerbi_rainfall_deficit_score: "PAGASA Power BI Rainfall Deficit",
      pagasa_powerbi_dry_spell_probability_pct: "PAGASA Power BI Dry Spell Probability",
      drrmis_elnino_historical_impact_score: "DRRMIS Historical Impact",
      drrmis_elnino_episode_count: "DRRMIS Episode Count",
      drrmis_elnino_total_value_loss_php: "DRRMIS Value Loss",
      drrmis_elnino_total_area_affected_ha: "DRRMIS Area Affected",
      drrmis_elnino_total_farmers_affected: "DRRMIS Farmers/Fisherfolk",
      drrmis_elnino_latest_total_value_loss_php: "Latest DRRMIS Value Loss",
      elnino_resilience_priority_score: "El Nino Resilience Priority",
      elnino_resilience_climate_exposure_score: "Climate Exposure",
      elnino_resilience_farmer_vulnerability_score: "Farmer Vulnerability",
      elnino_resilience_production_sensitivity_score: "Production Sensitivity",
      elnino_resilience_response_capacity_gap_score: "Response Capacity Gap",
      elnino_resilience_implementation_gap_score: "Implementation Gap",
      ...
      abemis_total_projects: "ABEMIS Projects",
      abemis_total_cost: "ABEMIS Project Cost",
      abemis_avg_cost_per_project: "ABEMIS Avg Cost per Project",
      abemis_fmr_projects: "ABEMIS FMR Projects",
      abemis_irrigation_projects: "ABEMIS Irrigation/Water Projects",
      abemis_postharvest_projects: "ABEMIS Postharvest/Processing Projects",
      abemis_protected_cultivation_projects: "ABEMIS Protected Cultivation Projects",
      abemis_farm_to_market_road_count: "ABEMIS FMR Projects",
      abemis_small_water_impounding_project_count: "ABEMIS SWIP Projects",
      abemis_solar_powered_irrigation_system_count: "ABEMIS Solar Irrigation Projects",
      rsba_registry_count: "RSBSA Registry Records",
      rsba_crop_area_ha: "RSBSA Crop Area",
      rsba_farmer_count: "RSBSA Farmer Records",
      rsba_farmworker_count: "RSBSA Farmworker Records",
      rsba_fisherfolk_count: "RSBSA Fisherfolk Records",
      rsba_rice_count: "RSBSA Rice/Palay Records",
      rsba_rice_area_ha: "RSBSA Rice/Palay Area",
      rsba_corn_count: "RSBSA Corn Records",
      rsba_corn_area_ha: "RSBSA Corn Area",
      rsba_4ps_count: "RSBSA 4Ps Records",
      rsba_ip_count: "RSBSA IP Records",
      rsba_pwd_count: "RSBSA PWD Records",
      rsba_female_count: "RSBSA Female Records",
      rsba_youth_count: "RSBSA Youth Records",
      rsba_fca_count: "RSBSA FCA Members",
      rsba_fca_gap_pct: "RSBSA Non-FCA Share",
      rsba_with_imc_count: "RSBSA With IMC",
      rsba_imc_gap_pct: "RSBSA Without IMC Share",
