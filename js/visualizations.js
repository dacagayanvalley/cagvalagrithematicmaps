...
const Visualizations = (() => {
  ...
  function attachPopup(feature, layer, highlightField) {
    ...
    const sections = [
      ...
      { label: "PRiSM Rice Monitoring", fields: ["prism_rice_area_2026s1", "prism_production_mt", "prism_yield_mt_ha", "prism_standing_crop_area", "prism_harvest_progress_pct", "prism_upcoming_harvest_area", "prism_area_gap_vs_app_ha"] },
      { label: "PRiSM Flood Damage", fields: ["prism_flood_damage_priority_score", "prism_flood_damage_priority_class", "prism_flooded_rice_total_ha", "prism_flooded_standing_crop_ha", "prism_flooded_reproductive_ripening_ha", "prism_flooded_standing_share_pct", "prism_expected_production_at_risk_mt"] },
      ...
      { label: "DRRMIS Historical El Nino", fields: ["drrmis_elnino_historical_impact_score", "drrmis_elnino_historical_impact_class", "drrmis_elnino_episode_count", "drrmis_elnino_total_value_loss_php", "drrmis_elnino_total_area_affected_ha", "drrmis_elnino_total_farmers_affected", "drrmis_elnino_latest_total_value_loss_php"] },
      { label: "El Nino Resilience", fields: ["elnino_resilience_priority_score", "elnino_resilience_climate_exposure_score", "elnino_resilience_farmer_vulnerability_score", "elnino_resilience_production_sensitivity_score", "elnino_resilience_response_capacity_gap_score", "elnino_resilience_implementation_gap_score"] },
      { label: "BSWM FertMap", fields: ["bswm_fertilizer_constraint_score", "bswm_sample_count", "bswm_coordinate_count", "bswm_coverage_confidence_score", "bswm_acidic_sample_pct", "bswm_low_om_pct", "bswm_low_p_pct", "bswm_low_k_pct", "bswm_multiple_low_npk_pct"] },
